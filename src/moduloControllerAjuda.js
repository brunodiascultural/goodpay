...
class ControllerMenuAjuda {
    ...
    pesquisa(){
        document.forms.search.addEventListener("submit", (e) => {
            ...
            const listaSugestaoStorage = this.getLocalStorage("listaSugestao") || [];
    ...
    get listaSugestao(){
        const listaSugestaoStorage =
            this.getLocalStorage("listaSugestao").reverse() || [];
    ...
    modalBase() {
        const myModal = new bootstrap.Modal(document.getElementById("modalHelp"));
        return myModal;
    }
